/**
 * Created by Christopher on 10/8/2015.
 */
import javax.swing.*;
import java.awt.*;
...
public class Phase1 {
   ...
   private static class Model{
      ...
      public Model(Controller controller, View view){
         ...
         this.view = view;
         this.highCardGame = new CardGameFramework(this.numPacksPerDeck, this.numJokersPerPack, this.numUnusedCardsPerPack, this.unusedCardsPerPack, Phase1.NUM_PLAYERS, Phase1.NUM_CARDS_PER_HAND);
      }
   ...
   private static class View{
      ...
      class CardTable extends JFrame {
         ...
         public JPanel pnlPlayArea, pnlPlayedCards, pnlPlayerText, pnlStatusText;
